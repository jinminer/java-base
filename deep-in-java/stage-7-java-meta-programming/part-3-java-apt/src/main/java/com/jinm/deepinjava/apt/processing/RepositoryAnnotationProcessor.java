 ...
 * 2. 指定需要处理的注解类名（集合）
 * 3. 指定支持的 Java 源代码版本
 * 4. 指定支持的 Processorcom.jinm.deepinjava.apt.reflection.Repository 参数 Options（可选）
...
public class RepositoryAnnotationProcessor extends AbstractProcessor {
    ...
    public static final String REPOSITORY_ANNOTATION_CLASS_NAME = "com.jinm.deepinjava.apt.reflection.Repository";

    private static final String CRUD_REPOSITORY_INTERFACE_CLASS_NAME = "com.jinm.deepinjava.apt.reflection.CrudRepository";
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        roundEnv.getRootElements()
                .stream()
                .filter(this::isRepositoryAnnotationPresent) // 过滤标注 @com.jinm.deepinjava.apt.reflection.Repository 的元素
                .forEach(this::processRepositoryAnnotatedElement);     // 处理标注 @com.jinm.deepinjava.apt.reflection.Repository 的元素
...
//        return singleton("com.jinm.deepinjava.apt.reflection.Repository");
//    }
}
