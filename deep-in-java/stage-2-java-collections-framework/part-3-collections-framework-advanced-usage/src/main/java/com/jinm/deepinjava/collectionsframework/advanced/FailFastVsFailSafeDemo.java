package com.jinm.deepinjava.collectionsframework.advanced;
...
public class FailFastVsFailSafeDemo {
    ...
    private static void demoFailSafe() {
        removeForEach(new CopyOnWriteArrayList<>(new ArrayList<>(Arrays.asList(1, 2, 3))));
    }

    private static void demoFailFast() {
        removeForEach(new ArrayList(new ArrayList<>(Arrays.asList(1, 2, 3))));
    }
